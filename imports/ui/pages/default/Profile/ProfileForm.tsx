...
import { Box, Button, FormControl, FormLabel, Input, Text, VStack, SimpleGrid, useToast } from '@chakra-ui/react';
...
const ProfileForm: React.FC = () => {
    ...
    const toggleEdit = () => {
        if (isEditing) {
            Meteor.call('user.profile.update', Meteor.userId(), profile, (err: Meteor.Error | null) => {
                if (err) {
                ...
                <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4} width="full">
                    ...
                    <FormControl>
                        ...
                        {isEditing && !user.profile.birthday ? (
                            ...
                            <Text>{profile.birthday ? profile.birthday.toDateString() : '-'}</Text>
                        )}
                    </FormControl>
                </SimpleGrid>
