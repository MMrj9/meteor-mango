...
describe('logChanges', () => {
  ...
  beforeEach(() => {
    ...
    userStub = sinon.stub(Meteor, 'user').returns({ _id: 'id', username: 'testUser' });
  });
  ...
  it('should log changes when fields are updated', () => {
    ...
    const changes = logChanges('doc123', 'Users', 'update', existingDoc, updatedDoc);
  ...
  it('should handle array changes correctly', () => {
    ...
    const changes = logChanges('doc123', 'Items', 'update', existingDoc, updatedDoc);
  ...
  it('should log new fields on document creation', () => {
    ...
    const changes = logChanges('doc123', 'Users', 'create', undefined, updatedDoc);
